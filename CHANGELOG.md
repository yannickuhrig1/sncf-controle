...
### Corrigé
- Navigation : Manager, Paramètres et Profil toujours visibles pour les managers, indépendamment des préférences de pages sauvegardées

## [1.10.87] - 2026-04-01

### Ajouté
- Infos > Présentation : téléchargement PDF direct pour les deux présentations (fichiers PDF générés et hébergés)
...
### Ajouté
- **À bord — rejoindre session** : rechargement automatique de la page après avoir rejoint une session (via QR code ou code manuel)
...
### Corrigé
- Dashboard › widget Départs/Arrivées : toggle "Par gare / Par numéro" remis, padding ajouté, `overflow-hidden` supprimé (causait la bordure rouge coupée sur l'input)

## [1.10.69] - 2026-03-28

### Corrigé
- Dashboard : le toggle "Par gare / Par numéro" du widget Départs/Arrivées n'apparaît plus sur le dashboard (uniquement dans la page Infos)

## [1.10.68] - 2026-03-28

### Corrigé
- Bouton Schéma (À bord) : si pas de composition dispo (TER, etc.), affiche l'itinéraire complet en fallback (arrêts + horaires) via l'API SNCF lookup
...
### Modifié
- Taux de fraude : les trains supprimés (`is_cancelled`) sont exclus du calcul (numérateur + dénominateur)
- Taux de fraude : les trains en sur-occupation avec 0 passager (`is_overcrowded && nb_passagers = 0`) sont exclus du calcul
...
### Corrigé
- Présentation : suppression du logo redondant au-dessus du titre "Application de Suivi des Contrôles"
...
### Corrigé
- Logo : utilisation de icon-192.png (vrai contrôleur cartoon) à la place du SVG basique

## [1.10.58] - 2026-03-16

### Modifié
- Logo : remplacement de l'icône ClipboardCheck par le contrôleur SNCF dans la sidebar, le header mobile et le menu burger
- Présentation : logo contrôleur remplace les emojis 🚆🚄 dans la slide de titre, les footers et les mockups

## [1.10.57] - 2026-03-15

### Modifié
- Dashboard : vignette "Départs/Arrivées en gare" — icône Train + gradient bleu identique à la tuile InfosUtiles

## [1.10.56] - 2026-03-15

### Modifié
- Dashboard : vignette "Départs / Arrivées" affiche le widget en ligne (dépliable) au lieu de naviguer vers Infos utiles
- OnboardControl : retrait du widget Départs/Arrivées (mauvaise page)

## [1.10.55] - 2026-03-14

### Ajouté
- OnboardControl : section "Départs / Arrivées en gare" collapsible intégrée directement dans la page contrôle à bord
